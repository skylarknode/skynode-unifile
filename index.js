...
Unifile.GitHubConnector = require('./connectors/github.js');
Unifile.DropboxConnector = require('./connectors/dropbox.js');
Unifile.FtpConnector = require('./connectors/ftp.js');
Unifile.RemoteStorageConnector = require('./connectors/remoteStorage.js');
Unifile.FsConnector = require('./connectors/fs.js');
Unifile.SftpConnector = require('./connectors/sftp.js');
